...
type TabDef = {
  path: "overview" | "deployments" | "variables" | "volumes" | "files" | "settings";
  label: string;
  route: "/apps/$appId/overview" | "/apps/$appId/deployments" | "/apps/$appId/variables" | "/apps/$appId/volumes" | "/apps/$appId/files" | "/apps/$appId/settings";
};
